...
Next we will perform the K meadiods on 3,4,5 clusters , and I found that the model doesnt seem to find enough observations to assign to the last clusters (4 and 5), and therefor I decided to stay with 3.

What we can see is quite interesting. First off , the vast majority of the countries are 170,34,9 . I would interpret this as most of the countries dealing with the Covid 19 the same way , having the same behavior of the weekly cases.
